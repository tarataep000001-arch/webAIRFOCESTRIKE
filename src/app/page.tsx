      ...
      <div className="relative z-10 space-y-20 pb-20">
        ...
        >
          <div className="grid gap-4">
            <div className="rounded-3xl border border-gold/20 bg-panel-strong/90 p-5 backdrop-blur-md">
              ...
              <p className="mt-3 text-lg font-semibold text-silver">
                AIR FORCE STRIKE is presented as a high-end, easy-to-scan
                landing page with dedicated routes for every major category.
              </p>
            </div>
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-3xl border border-gold/15 bg-white/[0.05] p-4 backdrop-blur-md">
            ...
            <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-center">
              <div>
                ...
                <p className="mt-3 max-w-2xl text-base leading-7 text-foreground-soft">
                  Each page now has its own dedicated content, so the homepage
                  can stay clean and premium.
                </p>
              </div>
