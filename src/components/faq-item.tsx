...
export function FaqItem({ item }: FaqItemProps) {
  return (
    <details className="group rounded-[1.4rem] border border-gold/20 bg-[linear-gradient(180deg,rgba(17,17,19,0.96),rgba(9,9,11,0.96))] p-4 transition duration-300 hover:border-gold/40 sm:p-6">
